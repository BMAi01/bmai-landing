...
(function () {
  const DICT = {
    pt: {
      ...
      'faq.7.a':   'Entre 20 e 35 dias em média, dependendo do escopo. Diagnóstico + Estruturação levam 2 a 4 semanas, Implementação 3 a 6 semanas. Por ser análise bem feita, o ROI aparece no primeiro mês — não é milagre, é personalização somada a método. Cronograma preciso é entregue na fase de Estruturação, com marcos semanais.',
    ...
    en: {
      ...
      'faq.8.a':   'If we built it, we maintain it. We don\'t leave you stranded. The final "A" in DEIA is Accompaniment: we monitor indicators, tune prompt and logic as your business evolves, and give you access to our internal SaaS for metric tracking. BMAi clients become partners — not just another account.',

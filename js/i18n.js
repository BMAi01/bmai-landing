...
(function () {
  const DICT = {
    pt: {
      ...
      'team.thiago.role':  'COO · Diretor Operacional',
      'team.thiago.bio':   'Operação boa é operação invisível. Quando tudo funciona sem ruído, sem retrabalho e sem depender de ninguém específico — aí sim o negócio está pronto para escalar. É isso que eu construo dentro de cada empresa que a BMAI atende.',
      'team.thiago.sig':   'COO · Diretor Operacional · BMAI',
    ...
    en: {
      ...
      'team.thiago.role':  'COO · Operations Director',
      'team.thiago.bio':   'Good operations are invisible operations. When everything runs without noise, without rework, without depending on any one person — that\'s when the business is ready to scale. That\'s what I build inside every company BMAI serves.',
      'team.thiago.sig':   'COO · Operations Director · BMAI',
    ...
    es: {
      ...
      'team.thiago.role':  'COO · Director Operacional',
      'team.thiago.bio':   'Buena operación es operación invisible. Cuando todo funciona sin ruido, sin retrabajo y sin depender de nadie específico — ahí el negocio está listo para escalar. Eso es lo que construyo dentro de cada empresa que BMAI atiende.',
      'team.thiago.sig':   'COO · Director Operacional · BMAI',
